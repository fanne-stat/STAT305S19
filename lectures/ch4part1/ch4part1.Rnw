...
\begin{center}
<<echo=F, fig = TRUE, fig.width = 10, fig.height=6, out.height = ".6\\textheight", out.width = ".8\\textwidth", small.mar = T>>=
 par(cex = 2)
...
\begin{center}
<<echo=F, small.mar = T, out.width = "0.8\\textwidth", out.height = "0.8\\textheight", fig=TRUE>>=
par(cex = 1.75)
plot(hardness ~ time, xlab = "Time (hours)", ylab ="Hardness (units)", data = r)
...
cf[2] = round(cf[2], 8)
txt = paste("y ~", cf[1], "+", cf[2], "x")
text(x = 4000, y = 2.75, labels = txt, col = "blue", cex = 0.5)
@
\end{center}
\vspace{-2em}
\begin{itemize}
...
\end{itemize}
\vspace{-4em}
<<echo = F, fig = TRUE, small.mar = T, out.height = ".6\\textheight", out.width = ".6\\textwidth">>=
par(cex = 2)
...
\vspace{-4em}
\begin{center}
<<echo=F, fig = TRUE, fig.height = 5, out.height = ".35\\textheight", out.width = "0.6\\textwidth", small.mar = T>>=
par(cex = 1.5)
