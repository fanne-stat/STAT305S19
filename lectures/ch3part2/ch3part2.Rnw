...
\begin{center}
\setkeys{Gin}{width= .7\textwidth} \includegraphics{../../fig/towelqqdata.png}
\end{center}
\end{frame}
...
\frametitle{Example: towel breaking strength data}
\begin{center}
\setkeys{Gin}{width= .65\textwidth} \includegraphics{../../fig/towelqqplot.png}
\end{center}
...
\begin{frame}
<<echo=F, fig.width = 6.5, fig.height=4.75, fig = TRUE>>=
  par(cex=1.25)
